...
model FMIRaven_Models_LorenzSystem_Inputs_fmu
// Model automatically generated by Dymola from FMI model description
public
  constant Real sigma = 1;
  constant Real rho = 1;
  constant Real beta = 1;
...
public
  parameter String fmi_instanceName="FMIRaven_Models_LorenzSystem_Inputs_fmu"
  ...
  annotation (Dialog(tab="FMI", group="Step time"));
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://FMIRaven_Models_LorenzSystem_Inputs_fmu/Resources/Library/FMU/FMIRaven_Models_LorenzSystem_Inputs/resources")
...
package fmi_Functions
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_Instantiate_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&FMIRaven_Models_LorenzSystem_0Inputs813613084018889151Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
    if (!(res->hInst=LoadLibraryW(L\"FMIRaven_Models_LorenzSystem_0Inputs.dll\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (FMIRaven_Models_LorenzSystem_0Inputs.dll) failed!\");
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{81361ad3-f0e8-4b0e-a188-8e9cbb15fc1f}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="FMIRaven_Models_LorenzSystem_0Inputs", LibraryDirectory=
              "modelica://FMIRaven/Resources/Library/FMU/FMIRaven_Models_LorenzSystem_Inputs/binaries",                                                                                            __Dymola_CriticalRegion="FMIRaven_Models_LorenzSystem_0Inputs");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
        ...
        input fmiModel fmi;
        external"C"
                   FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiFreeModelInstance2(fmi);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_Free_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    external"C" stepOK= FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiDoStep2(fmi, currentTime, stepSize);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_DoStep_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  return 1.0;
    ...
    function fmiReset
      ...
      external"C" resetOK = FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiReset2(fmi);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_Reset_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetReal_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetReal_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
#endif", Library="FMIRaven_Models_LorenzSystem_0Inputs", LibraryDirectory=
            "modelica://FMIRaven/Resources/Library/FMU/FMIRaven_Models_LorenzSystem_Inputs/binaries",                                                                                              __Dymola_CriticalRegion="FMIRaven_Models_LorenzSystem_0Inputs",__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    end fmiSetReal;
...
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetReal failed\");
    ...
    function fmiGetInteger
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetInteger_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetInteger_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiSetIntegerwf
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetInteger2wf(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetIntegerwf_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetIntegerwf_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetInteger2wf(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetBoolean_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetBoolean_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetString_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    protected
      Boolean dummy[size(refs, 1)];
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetBoolean2wf(
        fmi,
        refs,
        size(refs, 1),
        vals,
        dummy);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetBooleanwf_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_SetBooleanwf_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSetBoolean2wf(void*m, const int* refs, size_t nr, const int* vals, int* dummy) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetDirectionalDerivative2_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSaveFMUState2(fmi);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSaveFMUState_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiRestoreFMUState2(fmi);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiRestoreFMUState_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSerializeFMUstate2(fmi);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSerializeFMUstate_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiDeSerializeFMUstate2(fmi);
        annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiDeSerializeFMUstate_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmiEnterSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiEnterSlaveInitializationMode2(fmi, relativeTolerance, tStart, forceShutDownAtTStop, tStop);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiEnterSlaveInitializationMode_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiEnterSlaveInitializationMode2(void*m, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"InitializeSlave failed\");
    ...
    function fmiExitSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiExitSlaveInitializationMode2(fmi);
      annotation (Header="
#ifndef FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiExitSlaveInitializationMode_C
#define FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiExitSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void FMIRaven_Models_LorenzSystem_0Inputs813613084018889151_fmiExitSlaveInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2020x", experiment(StartTime=0.0, StopTime=100.0, Tolerance=0.0001),
    Icon(graphics={
      ...
      Bitmap(extent={{-95,-95},{95,95}}, fileName=
              "modelica://FMIRaven/Resources/Library/FMU/FMIRaven_Models_LorenzSystem_Inputs/model.png"),
...
<li>modelName = FMIRaven.Models.LorenzSystem_Inputs</li>
<li>generationTool = Dymola Version 2020x (64-bit), 2019-10-10 (using Dassl with tolerance 0.0001)</li>
<li>generationDateAndTime = 2020-02-28T18:50:43Z</li>
</ul>
...
end FMIRaven_Models_LorenzSystem_Inputs_fmu;
